...
export interface ApiGlobalConfigGlobalConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    departmentOptions: Schema.Attribute.JSON;
    footerCopyright: Schema.Attribute.String;
    footerMenuColumn1Label: Schema.Attribute.String;
    footerMenuColumn1Links: Schema.Attribute.Relation<
      'oneToMany',
      'api::page.page'
    >;
    footerMenuColumn2Label: Schema.Attribute.String;
    footerMenuColumn2Links: Schema.Attribute.Relation<
      'oneToMany',
      'api::page.page'
    >;
    footerMenuColumn3Label: Schema.Attribute.String;
    footerMenuColumn3Links: Schema.Attribute.Relation<
      'oneToMany',
      'api::page.page'
    >;
    footerMenuColumn4Label: Schema.Attribute.String;
    footerMenuColumn4Links: Schema.Attribute.Relation<
      'oneToMany',
      'api::page.page'
    >;
    footerSecondaryMenu: Schema.Attribute.Relation<
      'oneToMany',
      'api::page.page'
    >;
    footerSocialMediaIcon: Schema.Attribute.Media<'images'>;
    footerSocialMediaLabel: Schema.Attribute.String;
    footerSocialMediaLink: Schema.Attribute.String;
    headerMenu: Schema.Attribute.Relation<
      'oneToMany',
      'api::menu-item.menu-item'
    >;
    headerPrefix: Schema.Attribute.JSON;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    social_handles: Schema.Attribute.Relation<
      'oneToMany',
      'api::social-handle.social-handle'
    >;
    suggestedLanguages: Schema.Attribute.JSON;
    suggestedSkills: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiGroupCardGroupCard extends Struct.CollectionTypeSchema {
  collectionName: 'group_cards';
  info: {
    displayName: 'Group Card';
    pluralName: 'group-cards';
    singularName: 'group-card';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    items: Schema.Attribute.Relation<'oneToMany', 'api::card.card'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiMenuItemMenuItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    pageLink: Schema.Attribute.Relation<'manyToOne', 'api::page.page'>;
    publishedAt: Schema.Attribute.DateTime;
    submenuItems: Schema.Attribute.Relation<
      'oneToMany',
      'api::menu-item.menu-item'
    >;
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      [
        ...
        'sections.title-richtext',
        'sections.title-repeater',
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    headerBackgroundType: Schema.Attribute.Enumeration<
      ['white', 'transparent']
    > &
      Schema.Attribute.Required &
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Relation<'manyToOne', 'api::tag.tag'>;
    cf_createdAt: Schema.Attribute.DateTime & Schema.Attribute.Required;
    ...
    numbers: Schema.Attribute.JSON;
    postTags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
    postType: Schema.Attribute.Enumeration<['News', 'Case Study', 'Articles']> &
      Schema.Attribute.Required;
    preventIndexing: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dataSheetDocument: Schema.Attribute.Media<'files'>;
    description: Schema.Attribute.RichText & Schema.Attribute.Required;
    diagram: Schema.Attribute.Media<'images'>;
    images: Schema.Attribute.Media<'images', true>;
    keyFeatures: Schema.Attribute.JSON;
    keyFeaturesImage: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
    ...
    preventIndexing: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    productTags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
    publishedAt: Schema.Attribute.DateTime;
    seoDescription: Schema.Attribute.String;
    seoKeywords: Schema.Attribute.JSON;
    seoTitle: Schema.Attribute.String;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    userManualDocument: Schema.Attribute.Media<'files'>;
    video: Schema.Attribute.Media<'videos'>;
  };
}

export interface ApiSocialHandleSocialHandle
  extends Struct.CollectionTypeSchema {
  collectionName: 'social_handles';
  info: {
    displayName: 'Social Handle';
    pluralName: 'social-handles';
    singularName: 'social-handle';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cf_type: Schema.Attribute.Enumeration<
      [
        'product-tag',
        'news-category',
        'blog-category',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::group-card.group-card': ApiGroupCardGroupCard;
